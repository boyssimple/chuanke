...
- (UIButton *)closeButton {
    if (!_closeButton) {
        _closeButton = [[UIButton alloc]initWithFrame:CGRectMake(DEVICE_WIDTH - 44, DEVICE_HEIGHT - 44, 44, 44)];
...
- (UIButton *)cameraButton {
    if (!_cameraButton) {
        _cameraButton = [[UIButton alloc]initWithFrame:CGRectMake(DEVICE_WIDTH - 98, DEVICE_HEIGHT - 44, 44, 44)];
...
- (UIButton *)beautyButton {
    if (!_beautyButton) {
        _beautyButton = [[UIButton alloc]initWithFrame:CGRectMake(DEVICE_WIDTH - 152, DEVICE_HEIGHT - 44, 44, 44)];
